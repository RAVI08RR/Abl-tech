...
const defaultNavItems: NavItem[] = [
  {
    ...
    megaMenu: true,
    children: [
      { label: 'Software Development', href: '/services/software-development', description: 'Custom software solutions', icon: '💻' },
      { label: 'Web Development', href: '/services/web-development', description: 'Modern web applications', icon: '🌐' },
      { label: 'Mobile App Development', href: '/services/mobile-app-development', description: 'iOS & Android apps', icon: '📱' },
      { label: 'AI & Machine Learning', href: '/services/ai-machine-learning', description: 'Intelligent automation', icon: '🤖' },
      { label: 'Cloud Solutions', href: '/services/cloud-solutions', description: 'Scalable cloud infrastructure', icon: '☁️' },
      { label: 'UI/UX Design', href: '/services/ui-ux-design', description: 'User-centered design', icon: '🎨' },
      { label: 'Digital Transformation', href: '/services/digital-transformation', description: 'End-to-end transformation', icon: '🔄' },
      { label: 'Application Modernization', href: '/services/application-modernization', description: 'Legacy system upgrade', icon: '⚡' },
    ],
  },
