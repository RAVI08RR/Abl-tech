...
const defaultTestimonials: Testimonial[] = [
  {
    ...
    testimonial: 'ABL BusinessTech completely transformed how we operate digitally. Their team didn\'t just build software — they became true partners in our business transformation. The AI platform they delivered has become our biggest competitive advantage.',
    rating: 5,
    featured: true,
    order: 1,
  },
  ...
  },
  {
    ...
    testimonial: 'We needed a partner who understood both healthcare compliance and cutting-edge technology. ABL BusinessTech delivered exactly that. Their cloud architecture handles millions of patient records with zero downtime — remarkable work.',
    rating: 5,
    featured: true,
    order: 3,
  },
  {
    ...
    testimonial: 'As a startup, we needed a technology partner who could move fast without breaking things. ABL BusinessTech gave us enterprise-grade architecture from day one. We scaled from 0 to 50,000 daily users without any performance issues.',
    rating: 5,
    featured: true,
    order: 4,
  },
